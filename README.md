...
Due to the insane pixel layout of these displays some remapping of the framebuffer is needed before sending the data to the controller. I've used the viper decorator to get drawing a frame down to 5ms. Only landscape is currently supported.
...
lcd = ST7302(spi=spibus, cs=48, dc=47, rst=21, fps=ST7302.FPS8, init=True|False)
